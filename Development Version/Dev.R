...
structure(list(mz = c(NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 
234, 235.01, 236, 237.01, 238.01, NA, NA, NA, NA, NA, NA, NA,
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 311.91, 312.92, 313.91,
314.92, 315.91, 316.91, 317.92, NA, NA, NA, NA, NA, NA, NA, NA,
NA, NA, NA, NA, NA, NA, NA, NA, NA, 389.83, 390.83, 391.82, 392.83,
393.82, 394.82, 395.82, 396.82, 397.83, 398.83, NA, NA, NA, NA,
NA, NA, NA, NA, NA, NA, NA, NA, 467.74, 468.74, 469.73, 470.74,
471.73, 472.74, 473.73, 474.73, 475.73, 476.73, 477.73, NA, NA,
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 545.65, 546.65, 547.64,
548.65, 549.64, 550.65, 551.64, 552.64, 553.64, 554.64, 555.64,
556.64, 557.64, NA, NA, NA, NA, NA, NA, NA, NA, NA, 623.56, 624.56,
625.55, 626.56, 627.55, 628.56, 629.55, 630.55, 631.55, 632.55,
633.55, 634.55, 635.55, 636.55, 637.55, NA, NA, NA, NA, NA, NA,
NA, 701.47, 702.47, 703.47, 704.47, 705.46, 706.47, 707.46, 708.46,
709.46, 710.46, 711.46, 712.46, 713.46, 714.46, 715.45, 716.46,
NA, NA, NA, NA, NA, NA, NA, NA, 779.38, 780.38, 781.38, 782.38,
783.37, 784.38, 785.37, 786.38, 787.37, 788.37, 789.37, 790.37,
791.37, 792.37, 793.36, 794.37, 795.36, 796.36, NA, NA, NA, NA,
NA, NA, 857.29, 858.29, 859.29, 860.29, 861.28, 862.29, 863.28, 
864.29, 865.28, 866.28, 867.28, 868.28, 869.28, 870.28, 871.27,
872.28, 873.27, 874.28, 875.27, 877.28, NA, NA, 935.2, 936.2,
937.2, 938.2, 939.19, 940.2, 941.19, 942.2, 943.19, 944.19, 945.19,
946.19, 947.19, 948.19, 949.18, 950.19, 951.18, 952.19, 953.18,
954.18, 955.18, 956.18, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA,
NA, NA, 190.05, 191.06, 192.05, 193.06, 194.06, NA, NA, NA, NA,
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 224.02,
225.02, 226.01, 227.02, 228.01, 229.01, 230.02, 231.02, NA, NA,
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 257.98,
258.98, 259.97, 260.98, 261.97, 262.97, 263.97, 264.97, 265.97,
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 291.94, 292.94,
293.94, 294.94, 295.93, 296.94, 297.93, 298.93, 299.93, 300.93,
301.93, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 325.9,
326.9, 327.9, 328.9, 329.89, 330.9, 331.89, 332.89, 333.89, 334.89,
335.88, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 359.86,
360.86, 361.86, 362.86, 363.85, 364.86, 365.85, 366.85, 367.85, 
368.85, 369.85, 370.85, 371.84, NA, NA, NA, NA, NA, NA, NA, NA,
NA, NA, NA, 393.82, 394.82, 395.82, 396.82, 397.82, 398.82, 399.81,
400.82, 401.81, 402.81, 403.81, 404.81, 405.8, 406.82, NA, NA,
NA, NA, NA, NA, NA, NA, 427.78, 428.79, 429.78, 430.78, 431.78,
432.78, 433.77, 434.78, 435.77, 436.77, 437.77, 438.77, 439.77,
440.77, 441.76, NA, NA, NA, NA, NA, NA, NA, NA, NA, 461.74, 462.75,
463.74, 464.74, 465.74, 466.74, 467.73, 468.74, 469.73, 470.73,
471.73, 472.73, 473.73, 474.73, 475.72, NA, NA, NA, NA, NA, NA,
NA, NA, NA, 495.7, 496.71, 497.7, 498.7, 499.7, 500.7, 501.7,
502.7, 503.69, 504.7, 505.69, 506.69, 507.69, 508.69, 509.68,
510.69, 511.68, 513.68, NA, NA, NA, NA, NA, NA, NA, NA, 267.97,
268.97, 269.96, 270.97, 271.96, 272.96, 273.97, 274.97, NA, NA,
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 301.93,
302.93, 303.92, 304.93, 305.92, 306.92, 307.92, 308.92, 309.93,
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 335.89,
336.89, 337.89, 338.89, 339.88, 340.89, 341.88, 342.88, 343.88,
344.88, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 
369.85, 370.85, 371.85, 372.85, 373.84, 374.85, 375.84, 376.84,
377.84, 378.84, 379.84, 380.84, NA, NA, NA, NA, NA, NA, NA, NA,
NA, NA, 403.81, 404.81, 405.81, 406.81, 407.8, 408.81, 409.8,
410.8, 411.8, 412.8, 413.8, 414.8, 415.79, 416.8, NA, NA, NA,
NA, NA, NA, NA, NA, NA, NA, NA, NA, 345.88, 346.88, 347.87, 348.88,
349.87, 350.87, 351.87, 352.87, 353.88, NA, NA, NA, NA, NA, NA,
NA, NA, NA, NA, NA, NA, NA, NA, NA, 379.84, 380.84, 381.83, 382.84,
383.83, 384.84, 385.83, 386.83, 387.83, 388.83, 389.83, NA, NA,
NA, NA, NA, NA, NA, NA, NA, NA, NA, 413.8, 414.8, 415.8, 416.8,
417.79, 418.8, 419.79, 420.79, 421.79, 422.79, 423.79, 424.79,
425.79, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 447.76, 448.76,
449.76, 450.76, 451.75, 452.76, 453.75, 454.75, 455.75, 456.75,
457.75, 458.75, 459.74, 461.75, NA, NA, NA, NA, NA, NA, NA, NA,
NA, NA, 481.72, 482.72, 483.72, 484.72, 485.72, 486.72, 487.71,
488.72, 489.71, 490.71, 491.71, 492.71, 493.7, 494.71, 495.7,
NA, NA, NA, NA, NA, NA, NA, NA, NA, 423.79, 424.79, 425.78, 426.79,
427.78, 428.79, 429.78, 430.78, 431.78, 432.78, 433.78, NA, NA,
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 457.75, 458.75, 459.75, 
460.75, 461.74, 462.75, 463.74, 464.74, 465.74, 466.74, 467.74,
468.74, 469.74, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 491.71,
492.71, 493.71, 494.71, 495.7, 496.71, 497.7, 498.7, 499.7, 500.7,
501.7, 502.7, 503.69, 504.7, NA, NA, NA, NA, NA, NA, NA, NA,
NA, NA, 525.67, 526.67, 527.67, 528.67, 529.66, 530.67, 531.66,
532.67, 533.66, 534.66, 535.66, 536.66, 537.65, 538.66, 539.65,
NA, NA, NA, NA, NA, NA, NA, 559.63, 560.63, 561.63, 562.63, 563.63,
564.63, 565.62, 566.63, 567.62, 568.62, 569.62, 570.62, 571.62,
572.62, 573.61, 574.63, 575.61, NA, NA, NA, NA, NA, NA, NA, NA,
NA, 501.7, 502.7, 503.69, 504.7, 505.69, 506.7, 507.69, 508.69,
509.69, 510.69, 511.69, 512.69, 513.69, NA, NA, NA, NA, NA, NA,
NA, NA, NA, NA, NA, 535.66, 536.66, 537.66, 538.66, 539.65, 540.66,
541.65, 542.65, 543.65, 544.65, 545.65, 546.65, 547.64, 548.65,
NA, NA, NA, NA, NA, NA, NA, NA, 569.62, 570.62, 571.62, 572.62,
573.61, 574.62, 575.61, 576.62, 577.61, 578.61, 579.61, 580.61,
581.61, 582.61, 583.6, 584.61, NA, NA, NA, NA, NA, NA, NA, NA,
603.58, 604.58, 605.58, 606.58, 607.58, 608.58, 609.57, 610.58, 
611.57, 612.57, 613.57, 614.57, 615.57, 616.57, 617.56, 618.57,
619.56, 620.56, NA, NA, NA, NA, NA, NA, 637.54, 638.54, 639.54,
640.54, 641.54, 642.54, 643.53, 644.54, 645.53, 646.53, 647.53,
648.53, 649.53, 650.53, 651.52, 652.53, 653.52, 654.52, NA, NA,
NA, NA, NA, NA, 579.61, 580.61, 581.61, 582.61, 583.6, 584.61,
585.6, 586.6, 587.6, 588.6, 589.6, 590.6, 591.6, 592.6, NA, NA,
NA, NA, NA, NA, NA, NA, NA, NA, 613.57, 614.57, 615.57, 616.57,
617.56, 618.57, 619.56, 620.57, 621.56, 622.56, 623.56, 624.56,
625.56, 626.56, 627.55, 628.56, 629.56, NA, NA, NA, NA, NA, NA,
NA, 647.53, 648.53, 649.53, 650.53, 651.53, 652.53, 653.52, 654.53,
655.52, 656.52, 657.52, 658.52, 659.52, 660.52, 661.51, 662.52,
663.51, NA, NA, NA, NA, NA, NA, NA, 681.49, 682.49, 683.49, 684.49,
685.49, 686.49, 687.48, 688.49, 689.48, 690.48, 691.48, 692.48,
693.48, 694.48, 695.47, 696.48, 697.47, 698.47, NA, NA, NA, NA,
715.45, 716.45, 717.45, 718.45, 719.45, 720.45, 721.44, 722.45,
723.44, 724.45, 725.44, 726.44, 727.44, 728.44, 729.44, 730.44,
731.43, 732.43, 733.43, 734.43, NA, NA), intensity = c(0L, 0L, 
0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 4480L, 599L, 4342L, 553L, 26L,
0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
0L, 2203L, 319L, 4410L, 584L, 2196L, 270L, 18L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 1155L, 164L,
3330L, 425L, 3291L, 425L, 1067L, 133L, 9L, 1L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 615L, 76L, 2221L, 292L, 3309L,
432L, 2219L, 306L, 465L, 62L, 3L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 288L, 32L, 1422L, 167L, 2813L, 357L,
2756L, 327L, 1353L, 187L, 260L, 34L, 4L, 0L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 124L, 23L, 879L, 122L, 2150L, 267L, 2783L, 359L,
1990L, 267L, 774L, 109L, 139L, 13L, 1L, 0L, 0L, 0L, 0L, 0L, 0L,
0L, 66L, 7L, 491L, 67L, 1542L, 171L, 2421L, 285L, 2465L, 261L,
1437L, 207L, 453L, 44L, 73L, 10L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
0L, 34L, 4L, 308L, 29L, 1023L, 136L, 2001L, 233L, 2386L, 299L,
1859L, 254L, 958L, 145L, 255L, 37L, 35L, 4L, 0L, 0L, 0L, 0L,
0L, 0L, 18L, 2L, 190L, 20L, 648L, 81L, 1524L, 197L, 2193L, 267L,
2152L, 264L, 1450L, 164L, 588L, 84L, 120L, 14L, 23L, 1L, 0L, 
0L, 10L, 2L, 89L, 15L, 436L, 57L, 1115L, 129L, 1893L, 234L, 2155L,
288L, 1725L, 233L, 961L, 138L, 373L, 40L, 87L, 13L, 6L, 1L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 6588L, 867L, 2276L,
258L, 11L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 5106L, 637L, 3249L, 437L, 489L, 75L,
6L, 1L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
0L, 0L, 3791L, 535L, 3738L, 460L, 1177L, 177L, 111L, 8L, 3L,
0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 2895L, 407L,
3626L, 457L, 1867L, 242L, 424L, 48L, 31L, 2L, 1L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 2113L, 304L, 3536L, 485L,
2323L, 298L, 701L, 108L, 101L, 20L, 11L, 0L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 1678L, 224L, 3180L, 405L, 2612L,
320L, 1099L, 138L, 261L, 31L, 45L, 5L, 2L, 0L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 1236L, 183L, 2801L, 373L, 2755L, 333L,
1492L, 172L, 479L, 70L, 86L, 8L, 11L, 1L, 0L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 915L, 130L, 2494L, 324L, 2743L, 361L, 1781L, 240L,
707L, 92L, 164L, 21L, 23L, 4L, 1L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 
0L, 0L, 702L, 98L, 2068L, 280L, 2615L, 323L, 2114L, 267L, 962L,
147L, 286L, 57L, 66L, 3L, 12L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
0L, 496L, 72L, 1772L, 231L, 2503L, 353L, 2208L, 288L, 1207L,
165L, 492L, 63L, 100L, 18L, 24L, 4L, 3L, 1L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 3351L, 441L, 4393L, 571L, 1103L, 131L, 9L, 1L,
0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
2579L, 342L, 4129L, 533L, 1872L, 245L, 265L, 31L, 4L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 1888L, 251L,
3783L, 506L, 2481L, 303L, 652L, 83L, 44L, 9L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 1512L, 211L, 3308L, 468L,
2737L, 308L, 1064L, 140L, 197L, 33L, 17L, 5L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 1117L, 143L, 2894L, 368L, 2950L, 363L,
1448L, 171L, 400L, 52L, 80L, 9L, 4L, 1L, 0L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 0L, 1692L, 234L, 3847L, 494L, 2779L,
349L, 531L, 70L, 4L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 1301L, 193L, 3388L, 443L, 2903L, 391L, 1084L,
144L, 132L, 20L, 1L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
0L, 988L, 127L, 2837L, 359L, 3056L, 423L, 1522L, 216L, 399L, 
46L, 23L, 3L, 1L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
748L, 105L, 2416L, 318L, 2981L, 386L, 1915L, 248L, 680L, 75L,
108L, 12L, 7L, 1L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 574L,
71L, 1957L, 267L, 2876L, 365L, 2159L, 313L, 965L, 131L, 248L,
26L, 41L, 3L, 4L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 854L, 108L,
2838L, 374L, 3349L, 427L, 1561L, 210L, 254L, 24L, 1L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 657L, 93L, 2376L,
282L, 3187L, 426L, 1976L, 262L, 603L, 75L, 56L, 6L, 1L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 517L, 72L, 1898L, 213L, 3029L,
396L, 2345L, 277L, 876L, 145L, 197L, 21L, 13L, 1L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 0L, 0L, 410L, 60L, 1492L, 196L, 2701L, 354L,
2475L, 315L, 1316L, 161L, 384L, 62L, 59L, 8L, 7L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 309L, 39L, 1289L, 192L, 2434L, 311L, 2511L, 316L,
1517L, 207L, 611L, 88L, 132L, 23L, 19L, 1L, 1L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 0L, 472L, 64L, 1835L, 242L, 3012L, 409L, 2411L,
328L, 971L, 129L, 104L, 22L, 1L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
0L, 0L, 0L, 0L, 329L, 50L, 1527L, 184L, 2792L, 338L, 2639L, 299L,
1291L, 157L, 315L, 45L, 32L, 2L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 
0L, 251L, 33L, 1256L, 160L, 2483L, 326L, 2591L, 361L, 1587L,
202L, 547L, 79L, 99L, 14L, 10L, 1L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
0L, 175L, 33L, 961L, 148L, 2161L, 283L, 2587L, 341L, 1848L, 228L,
850L, 93L, 219L, 27L, 39L, 4L, 2L, 1L, 0L, 0L, 0L, 0L, 0L, 0L,
159L, 15L, 742L, 104L, 1896L, 232L, 2566L, 320L, 1969L, 268L,
1086L, 111L, 376L, 59L, 80L, 5L, 11L, 1L, 0L, 0L, 0L, 0L, 0L,
0L, 199L, 30L, 1191L, 144L, 2453L, 313L, 2784L, 359L, 1679L,
206L, 514L, 59L, 65L, 4L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
0L, 209L, 26L, 906L, 121L, 2158L, 283L, 2604L, 330L, 2032L, 229L,
783L, 99L, 173L, 28L, 17L, 1L, 1L, 0L, 0L, 0L, 0L, 0L, 0L, 0L,
121L, 18L, 726L, 87L, 1886L, 271L, 2561L, 334L, 2060L, 279L,
1103L, 136L, 299L, 40L, 64L, 11L, 4L, 0L, 0L, 0L, 0L, 0L, 0L,
0L, 98L, 14L, 557L, 76L, 1613L, 219L, 2362L, 317L, 2239L, 291L,
1321L, 177L, 504L, 76L, 96L, 18L, 19L, 3L, 0L, 0L, 0L, 0L, 66L,
10L, 452L, 60L, 1395L, 160L, 2179L, 287L, 2238L, 313L, 1534L,
202L, 709L, 78L, 231L, 33L, 46L, 2L, 3L, 2L, 0L, 0L), percent = c(0,
...
0.09, 0.13, 0.09, 0, 0), DistributionLabel = c("Br1", "Br1",
...
"Br5Cl5", "Br5Cl5", "Br5Cl5", "Br5Cl5", "Br5Cl5", "Br5Cl5", "Br5Cl5",
"Br5Cl5", "Br5Cl5", "Br5Cl5", "Br5Cl5", "Br5Cl5", "Br5Cl5", "Br5Cl5",
"Br5Cl5", "Br5Cl5", "Br5Cl5"), PeakNumber = c(-9L, -8L, -7L,
-6L, -5L, -4L, -3L, -2L, -1L, 0L, 1L, 2L, 3L, 4L, 5L, 6L, 7L,
8L, 9L, 10L, 11L, 12L, 13L, 14L, -9L, -8L, -7L, -6L, -5L, -4L,
-3L, -2L, -1L, 0L, 1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L,
12L, 13L, 14L, -9L, -8L, -7L, -6L, -5L, -4L, -3L, -2L, -1L, 0L,
1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L, 12L, 13L, 14L,
-9L, -8L, -7L, -6L, -5L, -4L, -3L, -2L, -1L, 0L, 1L, 2L, 3L,
4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L, 12L, 13L, 14L, -9L, -8L, -7L,
-6L, -5L, -4L, -3L, -2L, -1L, 0L, 1L, 2L, 3L, 4L, 5L, 6L, 7L,
8L, 9L, 10L, 11L, 12L, 13L, 14L, -9L, -8L, -7L, -6L, -5L, -4L,
-3L, -2L, -1L, 0L, 1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L,
12L, 13L, 14L, -9L, -8L, -7L, -6L, -5L, -4L, -3L, -2L, -1L, 0L,
...
4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L, 12L, 13L, 14L, -9L, -8L, -7L,
-6L, -5L, -4L, -3L, -2L, -1L, 0L, 1L, 2L, 3L, 4L, 5L, 6L, 7L,
8L, 9L, 10L, 11L, 12L, 13L, 14L)), class = "data.frame", row.names = c(NA,
-1080L))

# Select experimental distribution for comparison 

filter1_pass <- df[df$filter_1 == TRUE,]
distribution_names <- unique(theoretical_distributions$DistributionLabel)

# TODO set up data frame to store results

# for(i in filter1_pass$spectrum_number) {

  i = 1 #for development
  # Extract full experimental spectrum
  spectrum <- df[df$spectrum_number == filter1_pass$spectrum_number[i], ]

  for(i in filter1_pass$nominal_mz) {
    # Calculate nominal m/z range around Filter 1 = TRUE and extract the experimental distribution. Fill in all missing nominal m/z values. 
    mz_range <- data.frame(nominal_mz = seq(from = filter1_pass$nominal_mz[i] - 10, 
      to = filter1_pass$nominal_mz[i] + 12, by = 1))    
    experimental_distribution <- merge(mz_range, spectrum, by = 'nominal_mz', 
      all.x = TRUE, all.y = FALSE)
    experimental_distribution$intensity[is.na(experimental_distribution$intensity)] <- 0
    ...
    # TODO Scale the extracted experimental distribution. Max intensity is 100
    # x$percentIntensity <- with(x, intensity / max(intensity) * 100)

    for(j in length(distribution_names)) {
      tmp_theoretical <- theoretical_distributions[theoretical_distributions$DistributionLabel = distribution_names[j], ]
      x <- merge()
      ...
      # TODO Store spectrum_number, nominal_mz of filter1_pass$nominal_mz[i], and similarity score in data frame. This data frame stores all similarity scores.

    }

    # TODO select the best match and store in data frame

  }

#}

# TODO merge results data frame with df and apply threshold for passing filter 2
